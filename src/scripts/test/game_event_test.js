...
class GameEventTester{
    static EventDatabaseTestInit(){
        ...
        let game_event_02 = new GameEvent("Heat Event", "Let us play Heat!", new Date(2001, 1, 1, 16, 0, 0, 0),  new Date(2001, 1, 1, 20, 0, 0, 0), GameThemes.RACING);
        ...
        let game_event_04 = new GameEvent("Memoire 44 Event", "Let us play Memoire 44!", new Date(2001, 1, 1, 13, 0, 0, 0),  new Date(2001, 1, 1, 16, 0, 0, 0), GameThemes.WARGAME);
